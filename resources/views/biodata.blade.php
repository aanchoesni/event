        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('type_id', $type, old('type_id'), ['class' => 'form-control tkh select2','placeholder'=>'- Pilih -', 'required', 'id' => 'type']) }}
                </div>
                <div class="form-group" id="fmunit">
                    <label for="unit_id">Unit</label>
                    {{ Form::select('unit_id', $unit, old('unit_id'), ['class' => 'form-control tkh select2','placeholder'=>'- Pilih -', 'required', 'id' => 'unit']) }}
                </div>
                <div class="form-group">
