    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
            	{{ Form::open(array('url' => route('units.store'), 'method' => 'post', 'id' => 'category', 'class'=>'cmxform form-horizontal tasi-form')) }}
                <div class="form-group">
                    {{ Form::label('name', 'Nama Unit', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::text('name', null, array('class' => 'form-control tkh','placeholder'=>'Nama Unit')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('shortname', 'Nama Singkatan Unit', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::text('shortname', null, array('class' => 'form-control tkh','placeholder'=>'Nama Singkatan Unit')) }}
                    </div>
                </div>
                <div class="form-group">
