...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            ...
            <br><div style="padding-left: 15px"><a href="{{URL::to('admin/units/create')}}" class="btn btn-info"><i class="fa fa-plus"></i> Tambah</a></div>
                  ...
                  <table  class="display table table-bordered table-striped" id="tbmaster">
                    <thead>
                      <tr>
                        ...
                        <th style="text-align:center;" width="20%">Singkatan</th>
                      ...
                      @foreach($units as $value)
                        <tr>
                          ...
                          <td style="text-align:center;">
                            <a href="{{ route('units.edit', $value->id) }}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>

                            <button class="btn btn-danger btn-xs" id="btn_delete" data-file="{{$value->id}}"><i class="fa fa-trash-o"></i></button>
                            {{ Form::open(['url'=>route('units.destroy', ['data'=>Crypt::encrypt($value->id)]), 'method'=>'delete', 'id' => $value->id, 'style' => 'display: none;']) }}
                            {{ csrf_field() }}
                            {{ Form::close() }}
                          </td>
                        </tr>
