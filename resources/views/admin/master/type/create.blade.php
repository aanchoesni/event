    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
            	{{ Form::open(array('url' => route('type.store'), 'method' => 'post', 'id' => 'category', 'class'=>'cmxform form-horizontal tasi-form')) }}
                <div class="form-group">
                    {{ Form::label('name', 'Nama Tipe Peserta', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::text('name', null, array('class' => 'form-control tkh','placeholder'=>'Nama Tipe Peserta')) }}
                    </div>
                </div>
                <div class="form-group">
