...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            ...
            <br><div style="padding-left: 15px"><a href="{{URL::to('admin/users/create')}}" class="btn btn-info"><i class="fa fa-plus"></i> Tambah</a></div>
                      ...
                      @foreach($users as $value)
                        <tr>
                          ...
                          <td style="text-align:center;">
                            ...
                            {{ Form::open(['url'=>route('users.destroy', ['data'=>Crypt::encrypt($value->id)]), 'method'=>'delete', 'id' => $value->id, 'style' => 'display: none;']) }}
                            {{ csrf_field() }}
                            {{ Form::close() }}
                          </td>
                        </tr>
