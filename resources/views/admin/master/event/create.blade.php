    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
            	{{ Form::open(array('url' => route('events.store'), 'method' => 'post', 'id' => 'event', 'class'=>'cmxform form-horizontal tasi-form')) }}
                <div class="form-group">
                    {{ Form::label('title', 'Judul', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::text('title', null, array('class' => 'form-control tkh','placeholder'=>'Judul', 'required')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('theme', 'Tema', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::textarea('theme', null, array('class' => 'form-control tkh','placeholder'=>'Tema')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('description', 'Deskripsi', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::textarea('description', null, array('class' => 'form-control tkh','placeholder'=>'Deskripsi')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('category_id', 'Kategori', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::select('category_id', $categories, null, array('class' => 'form-control tkh','placeholder'=>'- Pilih -', 'required')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('unit_id', 'Unit', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::select('unit_id', $units, null, array('class' => 'form-control tkh','placeholder'=>'- Pilih -', 'required')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('place', 'Tempat', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::text('place', null, array('class' => 'form-control tkh','placeholder'=>'Tempat', 'required')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('date', 'Tanggal', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::text('date', null, array('class' => 'form-control tkh','placeholder'=>'Tanggal', 'required')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('times', 'Waktu', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::text('times', null, array('class' => 'form-control tkh','placeholder'=>'Waktu', 'required')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('quota', 'Kuota', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::text('quota', null, array('class' => 'form-control tkh','placeholder'=>'Kuota', 'onKeyPress' => 'return event.charCode >= 48 && event.charCode <= 57')) }}
                    </div>
                </div>
                @if (Auth::user()->role == 'admin')
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::checkbox('publication_status', null, null, ['class'=>'checkbox form-control', 'style'=>'width: 20px;']) }}
                    </div>
                </div>
                @endif
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                    {{ Form::text('start_reg', null, array('class' => 'form-control tkh','placeholder'=>'Awal Pendaftaran', 'required')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('end_reg', 'Akhir Pendaftaran', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                    {{ Form::text('end_reg', null, array('class' => 'form-control tkh','placeholder'=>'Akhir Pendaftaran', 'required')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{ Form::label('pay_status', 'Status Pembayaran', array('class' => 'control-label col-lg-2')) }}
                    <div class="col-lg-10">
                        {{ Form::checkbox('pay_status', null, null, ['class'=>'checkbox form-control', 'style'=>'width: 20px;', 'id'=>'statuspay']) }}
                    </div>
                </div>
                <div id="fmpay" style="display: none;">
                    <div class="form-group">
                        {{ Form::label('start_pay', 'Awal Pambayaran', array('class' => 'control-label col-lg-2')) }}
                        <div class="col-lg-10">
                        {{ Form::text('start_pay', null, array('class' => 'form-control tkh','placeholder'=>'Awal Pambayaran')) }}
                        </div>
                    </div>
                    <div class="form-group">
                        {{ Form::label('end_pay', 'Akhir Pambayaran', array('class' => 'control-label col-lg-2')) }}
                        <div class="col-lg-10">
                        {{ Form::text('end_pay', null, array('class' => 'form-control tkh','placeholder'=>'Akhir Pambayaran')) }}
                        </div>
                    </div>
                    <div class="form-group">
                        {{ Form::label('bank_name', 'Nama Bank', array('class' => 'control-label col-lg-2')) }}
                        <div class="col-lg-10">
                        {{ Form::text('bank_name', null, array('class' => 'form-control tkh','placeholder'=>'Nama Bank')) }}
                        </div>
                    </div>
                    <div class="form-group">
                        {{ Form::label('bank_number', 'Nomor Rekening', array('class' => 'control-label col-lg-2')) }}
                        <div class="col-lg-10">
                        {{ Form::text('bank_number', null, array('class' => 'form-control tkh','placeholder'=>'Nomor Rekening')) }}
                        </div>
                    </div>
                    <div class="form-group">
                        {{ Form::label('bank_owner', 'Atas Nama Rekening', array('class' => 'control-label col-lg-2')) }}
                        <div class="col-lg-10">
                        {{ Form::text('bank_owner', null, array('class' => 'form-control tkh','placeholder'=>'Atas Nama Rekening')) }}
                        </div>
                    </div>
                    <div class="form-group">
                        {{ Form::label('cost', 'Biaya', array('class' => 'control-label col-lg-2')) }}
                        <div class="col-lg-10">
                        {{ Form::text('cost', null, array('class' => 'form-control tkh','placeholder'=>'Biaya', 'onKeyPress' => 'return event.charCode >= 48 && event.charCode <= 57')) }}
                        </div>
                    </div>
                </div>
