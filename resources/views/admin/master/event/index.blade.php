                    ...
                    <thead>
                      ...
                      @foreach($events as $value)
                        <tr>
                          ...
                          <td>{!! $value->rUnit->name !!}</td>
                          <td>{!! $value->rCategory->name !!}</td>
                          <td>
                          ...
                          <td style="text-align:center; vertical-align: middle;">
                            <a href="{{ url('admin/participant/'.$value->id) }}" class="btn btn-success btn-xs"><i class="fa fa-user"></i></a>

                            <a href="{{ route('events.edit', $value->id) }}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
